# adapted from https://github.com/BioinfoMachineLearning/bio-diffusion.git
# and https://github.com/NVIDIA/NeMo/blob/main/nemo/collections/common/callbacks/ema.py
import torch
