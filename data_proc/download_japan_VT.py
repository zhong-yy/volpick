...
def download_japan_vt_event_waveforms():
    ...
    logger.info(f"Downloading volcanic-tectonic waveforms ...")

    catalog_table = pd.read_csv(volpick.cache_root / "Japan" / "japan_VT_with_PS.csv")
...
if __name__ == "__main__":
    download_japan_vt_event_waveforms()
    # with open("./NIED_account", "r") as f:
    #     username = f.readline().strip()
    #     password = f.readline().strip()
    # print((username))
