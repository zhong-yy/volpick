...
def download_japan_tec_lp_event_waveforms():
    ...
    logger.info(f"Downloading tectonic lp waveforms ...")

    catalog_table = pd.read_csv(
        volpick.cache_root / "Japan" / "japan_tec_LP_with_PS.csv"
    )
...
if __name__ == "__main__":
    download_japan_tec_lp_event_waveforms()
