...
## Model Usage
If you are only interested in the final model, please see folder `Final_models`, and ignore other folders.
...
- Gao, A. F., Wilding, J. D., Biondi, E., Bouman, K. L., & Ross, Z. E. (2026). High-resolution eikonal-based travel time tomography and uncertainty quantification of the Kilauea caldera. Geophysical Journal International, ggag179.
